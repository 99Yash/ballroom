...
│   ├── ui/                 # shadcn/ui components (DO NOT MODIFY DIRECTLY unless there's an issue)
│   ├── category-manager.tsx
│   ├── sync-button.tsx
│   └── video-card.tsx
├── db/
│   ├── index.ts            # Database connection
│   └── schemas/            # Drizzle schema definitions (whenever you change a schema or add indexes etc. run pnpm drizzle-kit generate first and then pnpm drizzle-kit migrate)
